...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/19 14:59:50 by hsisman           #+#    #+#             */
/*   Updated: 2022/08/19 19:08:13 by hsisman          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

int	ft_ten_set_a(t_list **list_a, t_list **list_b, int x) //ok
{
	int	min_place;
	int	place;
...
int	ft_ten_set_b(t_list **list_a, t_list **list_b, int x) //ok
{
	int	max_place;
	int	place;
...
void	ft_ten_push_half(t_list **list_a, t_list **list_b) //ok
{
	int	max;
	int	min;
	int	pivot;
